...
{
  #triggerName = "set_permission_unique_id";
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        -- Statements are executed individually, so no need of 'DELIMITER //'
        CREATE TRIGGER ${this.#triggerName} BEFORE INSERT ON permissions
        FOR EACH ROW
        BEGIN
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TRIGGER IF EXISTS ${this.#triggerName};`);
  }
}
